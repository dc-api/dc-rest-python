...
class TestChannelFollowerWebhookResponse(unittest.TestCase):
    """ChannelFollowerWebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelFollowerWebhookResponse:
        """Test ChannelFollowerWebhookResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelFollowerWebhookResponse`
        """
        model = ChannelFollowerWebhookResponse()
        if include_optional:
            return ChannelFollowerWebhookResponse(
                ...
                user = dc_rest.models.user_response.UserResponse(
                    ...
                    primary_guild = dc_rest.models.user_primary_guild_response.UserPrimaryGuildResponse(
                        ...
                        tag = '', 
                        badge = '', ), ),
                source_guild = dc_rest.models.webhook_source_guild_response.WebhookSourceGuildResponse(
                    id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                    icon = '', 
                    name = '', ),
                source_channel = dc_rest.models.webhook_source_channel_response.WebhookSourceChannelResponse(
                    id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                    name = '', )
            )
        else:
    ...
    def testChannelFollowerWebhookResponse(self):
        """Test ChannelFollowerWebhookResponse"""

...
class TestGuildWelcomeChannel(unittest.TestCase):
    """GuildWelcomeChannel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildWelcomeChannel:
        ...
        # uncomment below to create an instance of `GuildWelcomeChannel`
        """
    ...
    def testGuildWelcomeChannel(self):
        """Test GuildWelcomeChannel"""

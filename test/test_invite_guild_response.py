...
class TestInviteGuildResponse(unittest.TestCase):
    """InviteGuildResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteGuildResponse:
        ...
        # uncomment below to create an instance of `InviteGuildResponse`
        """
        model = InviteGuildResponse()
        if include_optional:
    ...
    def testInviteGuildResponse(self):
        """Test InviteGuildResponse"""

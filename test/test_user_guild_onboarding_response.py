...
class TestUserGuildOnboardingResponse(unittest.TestCase):
    """UserGuildOnboardingResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserGuildOnboardingResponse:
        ...
        # uncomment below to create an instance of `UserGuildOnboardingResponse`
        """
        model = UserGuildOnboardingResponse()
        if include_optional:
    ...
    def testUserGuildOnboardingResponse(self):
        """Test UserGuildOnboardingResponse"""

...
class TestMessageReactionResponse(unittest.TestCase):
    """MessageReactionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageReactionResponse:
        ...
        # uncomment below to create an instance of `MessageReactionResponse`
        """
    ...
    def testMessageReactionResponse(self):
        """Test MessageReactionResponse"""

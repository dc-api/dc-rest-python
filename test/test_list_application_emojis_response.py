...
class TestListApplicationEmojisResponse(unittest.TestCase):
    """ListApplicationEmojisResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListApplicationEmojisResponse:
        """Test ListApplicationEmojisResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListApplicationEmojisResponse`
        """
        model = ListApplicationEmojisResponse()
        if include_optional:
    ...
    def testListApplicationEmojisResponse(self):
        """Test ListApplicationEmojisResponse"""

...
class TestCreateForumThreadRequest(unittest.TestCase):
    """CreateForumThreadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateForumThreadRequest:
        """Test CreateForumThreadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateForumThreadRequest`
        """
        model = CreateForumThreadRequest()
        if include_optional:
            return CreateForumThreadRequest(
                ...
                message = dc_rest.models.base_create_message_create_request.BaseCreateMessageCreateRequest(
                    content = '', 
                    embeds = [
                    ...
                    poll = dc_rest.models.poll_create_request.PollCreateRequest(
                        ...
                        layout_type = 56, 
                        duration = 1, ), 
                    confetti_potion = dc_rest.models.confetti_potion.confetti_potion(), )
            )
        else:
            return CreateForumThreadRequest(
                name = '0',
    ...
    def testCreateForumThreadRequest(self):
        """Test CreateForumThreadRequest"""

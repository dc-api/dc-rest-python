...
class TestApplicationIncomingWebhookResponse(unittest.TestCase):
    """ApplicationIncomingWebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationIncomingWebhookResponse:
        ...
        # uncomment below to create an instance of `ApplicationIncomingWebhookResponse`
        """
        model = ApplicationIncomingWebhookResponse()
        if include_optional:
    ...
    def testApplicationIncomingWebhookResponse(self):
        """Test ApplicationIncomingWebhookResponse"""

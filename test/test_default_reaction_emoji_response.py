...
class TestDefaultReactionEmojiResponse(unittest.TestCase):
    """DefaultReactionEmojiResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultReactionEmojiResponse:
        ...
        # uncomment below to create an instance of `DefaultReactionEmojiResponse`
        """
        model = DefaultReactionEmojiResponse()
        if include_optional:
    ...
    def testDefaultReactionEmojiResponse(self):
        """Test DefaultReactionEmojiResponse"""

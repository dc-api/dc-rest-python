...
class TestIncomingWebhookUpdateRequestPartial(unittest.TestCase):
    """IncomingWebhookUpdateRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingWebhookUpdateRequestPartial:
        """Test IncomingWebhookUpdateRequestPartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingWebhookUpdateRequestPartial`
        """
        model = IncomingWebhookUpdateRequestPartial()
        if include_optional:
    ...
    def testIncomingWebhookUpdateRequestPartial(self):
        """Test IncomingWebhookUpdateRequestPartial"""

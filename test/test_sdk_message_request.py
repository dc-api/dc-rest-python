...
class TestSDKMessageRequest(unittest.TestCase):
    """SDKMessageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SDKMessageRequest:
        """Test SDKMessageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SDKMessageRequest`
        """
        model = SDKMessageRequest()
        if include_optional:
            return SDKMessageRequest(
                ...
                message_reference = dc_rest.models.message_reference_request.MessageReferenceRequest(
    ...
    def testSDKMessageRequest(self):
        """Test SDKMessageRequest"""

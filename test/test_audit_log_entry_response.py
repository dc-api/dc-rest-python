...
class TestAuditLogEntryResponse(unittest.TestCase):
    """AuditLogEntryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuditLogEntryResponse:
        """Test AuditLogEntryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuditLogEntryResponse`
        """
        model = AuditLogEntryResponse()
        if include_optional:
    ...
    def testAuditLogEntryResponse(self):
        """Test AuditLogEntryResponse"""

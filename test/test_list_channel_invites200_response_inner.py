...
class TestListChannelInvites200ResponseInner(unittest.TestCase):
    """ListChannelInvites200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListChannelInvites200ResponseInner:
        ...
        # uncomment below to create an instance of `ListChannelInvites200ResponseInner`
        """
        model = ListChannelInvites200ResponseInner()
        if include_optional:
    ...
    def testListChannelInvites200ResponseInner(self):
        """Test ListChannelInvites200ResponseInner"""

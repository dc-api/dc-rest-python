...
class TestGuildCreateRequest(unittest.TestCase):
    """GuildCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildCreateRequest:
        """Test GuildCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildCreateRequest`
        """
        model = GuildCreateRequest()
        if include_optional:
            return GuildCreateRequest(
                ...
                afk_timeout = 56,
                roles = [
                    dc_rest.models.create_guild_request_role_item.CreateGuildRequestRoleItem(
                        id = 56, 
                        name = '', 
                        permissions = 56, 
                        color = 0, 
                ...
                channels = [
                    dc_rest.models.create_guild_request_channel_item.CreateGuildRequestChannelItem(
                        type = 0, 
                        name = '0', 
                        position = 0, 
                        topic = '', 
                        ...
                        permission_overwrites = [
                            dc_rest.models.channel_permission_overwrite_request.ChannelPermissionOverwriteRequest(
                        ...
                        default_reaction_emoji = dc_rest.models.update_default_reaction_emoji_request.UpdateDefaultReactionEmojiRequest(
                        ...
                        id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                        available_tags = [
                            dc_rest.models.create_or_update_thread_tag_request.CreateOrUpdateThreadTagRequest(
                                name = '', 
                                emoji_name = '', 
                                moderated = True, )
                            ], )
    ...
    def testGuildCreateRequest(self):
        """Test GuildCreateRequest"""

...
class TestGuildHomeSettingsResponse(unittest.TestCase):
    """GuildHomeSettingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildHomeSettingsResponse:
        """Test GuildHomeSettingsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildHomeSettingsResponse`
        """
        model = GuildHomeSettingsResponse()
        if include_optional:
            return GuildHomeSettingsResponse(
                guild_id = '9072888001528021798096225500850762068629339333975650685139102691291',
                enabled = True,
                welcome_message = dc_rest.models.welcome_message_response.WelcomeMessageResponse(
                    author_ids = [
                        '9072888001528021798096225500850762068629339333975650685139102691291'
                        ], 
                    message = '', ),
                new_member_actions = [
                    dc_rest.models.new_member_action_response.NewMemberActionResponse(
                ...
                resource_channels = [
                    dc_rest.models.resource_channel_response.ResourceChannelResponse(
                        channel_id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                        title = '', 
                        emoji = dc_rest.models.message_reaction_emoji_response.MessageReactionEmojiResponse(
                            id = '9072888001528021798096225500850762068629339333975650685139102691291', 
    ...
    def testGuildHomeSettingsResponse(self):
        """Test GuildHomeSettingsResponse"""

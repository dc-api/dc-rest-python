...
class TestListGuildSoundboardSoundsResponse(unittest.TestCase):
    """ListGuildSoundboardSoundsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGuildSoundboardSoundsResponse:
        """Test ListGuildSoundboardSoundsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGuildSoundboardSoundsResponse`
        """
        model = ListGuildSoundboardSoundsResponse()
        if include_optional:
            return ListGuildSoundboardSoundsResponse(
                items = [
                    dc_rest.models.soundboard_sound_response.SoundboardSoundResponse(
                        name = '', 
                        sound_id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                        volume = 1.337, 
    ...
    def testListGuildSoundboardSoundsResponse(self):
        """Test ListGuildSoundboardSoundsResponse"""

...
class TestUserPIIResponse(unittest.TestCase):
    """UserPIIResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserPIIResponse:
        """Test UserPIIResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserPIIResponse`
        """
        model = UserPIIResponse()
        if include_optional:

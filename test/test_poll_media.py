...
class TestPollMedia(unittest.TestCase):
    """PollMedia unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PollMedia:
        """Test PollMedia
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PollMedia`
        """
        model = PollMedia()
        if include_optional:
            return PollMedia(

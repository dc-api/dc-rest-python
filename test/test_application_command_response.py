...
class TestApplicationCommandResponse(unittest.TestCase):
    """ApplicationCommandResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationCommandResponse:
        ...
        # uncomment below to create an instance of `ApplicationCommandResponse`
        """
        model = ApplicationCommandResponse()
        if include_optional:
    ...
    def testApplicationCommandResponse(self):
        """Test ApplicationCommandResponse"""

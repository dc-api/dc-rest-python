...
class TestGuildWithCountsResponse(unittest.TestCase):
    """GuildWithCountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildWithCountsResponse:
        """Test GuildWithCountsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildWithCountsResponse`
        """
        model = GuildWithCountsResponse()
        if include_optional:
    ...
    def testGuildWithCountsResponse(self):
        """Test GuildWithCountsResponse"""

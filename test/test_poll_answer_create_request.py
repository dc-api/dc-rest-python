...
class TestPollAnswerCreateRequest(unittest.TestCase):
    """PollAnswerCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PollAnswerCreateRequest:
        """Test PollAnswerCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PollAnswerCreateRequest`
        """
        model = PollAnswerCreateRequest()
        if include_optional:
    ...
    def testPollAnswerCreateRequest(self):
        """Test PollAnswerCreateRequest"""

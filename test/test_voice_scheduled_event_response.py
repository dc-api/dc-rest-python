...
class TestVoiceScheduledEventResponse(unittest.TestCase):
    """VoiceScheduledEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoiceScheduledEventResponse:
        """Test VoiceScheduledEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoiceScheduledEventResponse`
        """
        model = VoiceScheduledEventResponse()
        if include_optional:
    ...
    def testVoiceScheduledEventResponse(self):
        """Test VoiceScheduledEventResponse"""

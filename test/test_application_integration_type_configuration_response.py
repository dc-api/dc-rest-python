...
class TestApplicationIntegrationTypeConfigurationResponse(unittest.TestCase):
    """ApplicationIntegrationTypeConfigurationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationIntegrationTypeConfigurationResponse:
        """Test ApplicationIntegrationTypeConfigurationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationIntegrationTypeConfigurationResponse`
        """
        model = ApplicationIntegrationTypeConfigurationResponse()
        if include_optional:
    ...
    def testApplicationIntegrationTypeConfigurationResponse(self):
        """Test ApplicationIntegrationTypeConfigurationResponse"""

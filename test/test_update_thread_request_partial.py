...
class TestUpdateThreadRequestPartial(unittest.TestCase):
    """UpdateThreadRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateThreadRequestPartial:
        ...
        # uncomment below to create an instance of `UpdateThreadRequestPartial`
        """
        model = UpdateThreadRequestPartial()
        if include_optional:
    ...
    def testUpdateThreadRequestPartial(self):
        """Test UpdateThreadRequestPartial"""

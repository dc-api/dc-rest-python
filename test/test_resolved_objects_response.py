...
class TestResolvedObjectsResponse(unittest.TestCase):
    """ResolvedObjectsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResolvedObjectsResponse:
        ...
        # uncomment below to create an instance of `ResolvedObjectsResponse`
        """
        model = ResolvedObjectsResponse()
        if include_optional:
    ...
    def testResolvedObjectsResponse(self):
        """Test ResolvedObjectsResponse"""

...
class TestPrivateApplicationResponse(unittest.TestCase):
    """PrivateApplicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateApplicationResponse:
        """Test PrivateApplicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateApplicationResponse`
        """
        model = PrivateApplicationResponse()
        if include_optional:
            return PrivateApplicationResponse(
                ...
                owner = dc_rest.models.user_response.UserResponse(
                    id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                    username = '', 
                    avatar = '', 
                    discriminator = '', 
                    ...
                    primary_guild = dc_rest.models.user_primary_guild_response.UserPrimaryGuildResponse(
                        ...
                        tag = '', 
                        badge = '', ), ),
                approximate_guild_count = 56,
                approximate_user_install_count = 56,
                approximate_user_authorization_count = 56,
                explicit_content_filter = 56,
                team = dc_rest.models.team_response.TeamResponse(
                    id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                    icon = '', 
                    name = '', 
                    owner_user_id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                    members = [
                        dc_rest.models.team_member_response.TeamMemberResponse(
                            user = dc_rest.models.user_response.UserResponse(
                                ...
                                primary_guild = dc_rest.models.user_primary_guild_response.UserPrimaryGuildResponse(
                                    ...
                                    tag = '', 
                                    badge = '', ), ), 
                            team_id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                            membership_state = 56, )
                        ], )
            )
        else:
    ...
    def testPrivateApplicationResponse(self):
        """Test PrivateApplicationResponse"""

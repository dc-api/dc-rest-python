...
class TestGuildTemplateRoleResponse(unittest.TestCase):
    """GuildTemplateRoleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildTemplateRoleResponse:
        ...
        # uncomment below to create an instance of `GuildTemplateRoleResponse`
        """
        model = GuildTemplateRoleResponse()
        if include_optional:
    ...
    def testGuildTemplateRoleResponse(self):
        """Test GuildTemplateRoleResponse"""

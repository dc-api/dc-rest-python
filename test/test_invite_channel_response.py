...
class TestInviteChannelResponse(unittest.TestCase):
    """InviteChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteChannelResponse:
        """Test InviteChannelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteChannelResponse`
        """
        model = InviteChannelResponse()
        if include_optional:
    ...
    def testInviteChannelResponse(self):
        """Test InviteChannelResponse"""

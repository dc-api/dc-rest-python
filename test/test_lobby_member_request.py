...
class TestLobbyMemberRequest(unittest.TestCase):
    """LobbyMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LobbyMemberRequest:
        """Test LobbyMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LobbyMemberRequest`
        """
        model = LobbyMemberRequest()
        if include_optional:
    ...
    def testLobbyMemberRequest(self):
        """Test LobbyMemberRequest"""

...
class TestBasicMessageResponse(unittest.TestCase):
    """BasicMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicMessageResponse:
        """Test BasicMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicMessageResponse`
        """
        model = BasicMessageResponse()
        if include_optional:
    ...
    def testBasicMessageResponse(self):
        """Test BasicMessageResponse"""

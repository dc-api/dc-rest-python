...
class TestSoundboardPatchRequestPartial(unittest.TestCase):
    """SoundboardPatchRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoundboardPatchRequestPartial:
        """Test SoundboardPatchRequestPartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoundboardPatchRequestPartial`
        """
        model = SoundboardPatchRequestPartial()
        if include_optional:
    ...
    def testSoundboardPatchRequestPartial(self):
        """Test SoundboardPatchRequestPartial"""

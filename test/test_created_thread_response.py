...
class TestCreatedThreadResponse(unittest.TestCase):
    """CreatedThreadResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatedThreadResponse:
        """Test CreatedThreadResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatedThreadResponse`
        """
        model = CreatedThreadResponse()
        if include_optional:
    ...
    def testCreatedThreadResponse(self):
        """Test CreatedThreadResponse"""

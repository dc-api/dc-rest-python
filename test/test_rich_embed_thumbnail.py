...
class TestRichEmbedThumbnail(unittest.TestCase):
    """RichEmbedThumbnail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RichEmbedThumbnail:
        ...
        # uncomment below to create an instance of `RichEmbedThumbnail`
        """
        model = RichEmbedThumbnail()
        if include_optional:
    ...
    def testRichEmbedThumbnail(self):
        """Test RichEmbedThumbnail"""

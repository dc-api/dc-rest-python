...
class TestWidgetSettingsResponse(unittest.TestCase):
    """WidgetSettingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WidgetSettingsResponse:
        ...
        # uncomment below to create an instance of `WidgetSettingsResponse`
        """
        model = WidgetSettingsResponse()
        if include_optional:
    ...
    def testWidgetSettingsResponse(self):
        """Test WidgetSettingsResponse"""

...
class TestActivitiesAttachmentResponse(unittest.TestCase):
    """ActivitiesAttachmentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivitiesAttachmentResponse:
        """Test ActivitiesAttachmentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivitiesAttachmentResponse`
        """
        model = ActivitiesAttachmentResponse()
        if include_optional:
            return ActivitiesAttachmentResponse(
                attachment = dc_rest.models.attachment_response.AttachmentResponse(
    ...
    def testActivitiesAttachmentResponse(self):
        """Test ActivitiesAttachmentResponse"""

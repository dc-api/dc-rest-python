...
class TestStringSelectComponentResponse(unittest.TestCase):
    """StringSelectComponentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StringSelectComponentResponse:
        """Test StringSelectComponentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StringSelectComponentResponse`
        """
        model = StringSelectComponentResponse()
        if include_optional:
    ...
    def testStringSelectComponentResponse(self):
        """Test StringSelectComponentResponse"""

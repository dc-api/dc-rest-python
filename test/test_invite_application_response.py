...
class TestInviteApplicationResponse(unittest.TestCase):
    """InviteApplicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteApplicationResponse:
        """Test InviteApplicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InviteApplicationResponse`
        """
        model = InviteApplicationResponse()
        if include_optional:
            return InviteApplicationResponse(
    ...
    def testInviteApplicationResponse(self):
        """Test InviteApplicationResponse"""

...
class TestExternalScheduledEventPatchRequestPartial(unittest.TestCase):
    """ExternalScheduledEventPatchRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalScheduledEventPatchRequestPartial:
        ...
        # uncomment below to create an instance of `ExternalScheduledEventPatchRequestPartial`
        """
    ...
    def testExternalScheduledEventPatchRequestPartial(self):
        """Test ExternalScheduledEventPatchRequestPartial"""

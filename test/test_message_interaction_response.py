...
class TestMessageInteractionResponse(unittest.TestCase):
    """MessageInteractionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageInteractionResponse:
        """Test MessageInteractionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageInteractionResponse`
        """
        model = MessageInteractionResponse()
        if include_optional:
    ...
    def testMessageInteractionResponse(self):
        """Test MessageInteractionResponse"""

...
class TestMentionableSelectComponentResponseDefaultValuesInner(unittest.TestCase):
    """MentionableSelectComponentResponseDefaultValuesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MentionableSelectComponentResponseDefaultValuesInner:
        ...
        # uncomment below to create an instance of `MentionableSelectComponentResponseDefaultValuesInner`
        """
        model = MentionableSelectComponentResponseDefaultValuesInner()
        if include_optional:
    ...
    def testMentionableSelectComponentResponseDefaultValuesInner(self):
        """Test MentionableSelectComponentResponseDefaultValuesInner"""

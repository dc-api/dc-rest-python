...
class TestUpdateMessageInteractionCallbackRequest(unittest.TestCase):
    """UpdateMessageInteractionCallbackRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateMessageInteractionCallbackRequest:
        """Test UpdateMessageInteractionCallbackRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateMessageInteractionCallbackRequest`
        """
        model = UpdateMessageInteractionCallbackRequest()
        if include_optional:
            return UpdateMessageInteractionCallbackRequest(
                type = 56,
                data = dc_rest.models.incoming_webhook_update_for_interaction_callback_request_partial.IncomingWebhookUpdateForInteractionCallbackRequestPartial(
                    content = '', 
                    embeds = [
    ...
    def testUpdateMessageInteractionCallbackRequest(self):
        """Test UpdateMessageInteractionCallbackRequest"""

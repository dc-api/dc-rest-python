...
class TestInteractionCallbackResponseResource(unittest.TestCase):
    """InteractionCallbackResponseResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InteractionCallbackResponseResource:
        """Test InteractionCallbackResponseResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InteractionCallbackResponseResource`
        """
        model = InteractionCallbackResponseResource()
        if include_optional:
    ...
    def testInteractionCallbackResponseResource(self):
        """Test InteractionCallbackResponseResource"""

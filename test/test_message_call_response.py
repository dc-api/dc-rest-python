...
class TestMessageCallResponse(unittest.TestCase):
    """MessageCallResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageCallResponse:
        """Test MessageCallResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageCallResponse`
        """
        model = MessageCallResponse()
        if include_optional:
    ...
    def testMessageCallResponse(self):
        """Test MessageCallResponse"""

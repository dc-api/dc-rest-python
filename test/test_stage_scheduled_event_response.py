...
class TestStageScheduledEventResponse(unittest.TestCase):
    """StageScheduledEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StageScheduledEventResponse:
        """Test StageScheduledEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StageScheduledEventResponse`
        """
        model = StageScheduledEventResponse()
        if include_optional:
    ...
    def testStageScheduledEventResponse(self):
        """Test StageScheduledEventResponse"""

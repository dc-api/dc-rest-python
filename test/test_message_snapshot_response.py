...
class TestMessageSnapshotResponse(unittest.TestCase):
    """MessageSnapshotResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageSnapshotResponse:
        """Test MessageSnapshotResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageSnapshotResponse`
        """
        model = MessageSnapshotResponse()
        if include_optional:
    ...
    def testMessageSnapshotResponse(self):
        """Test MessageSnapshotResponse"""

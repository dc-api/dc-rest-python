...
class TestUpdateVoiceStateRequest(unittest.TestCase):
    """UpdateVoiceStateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateVoiceStateRequest:
        ...
        # uncomment below to create an instance of `UpdateVoiceStateRequest`
        """
        model = UpdateVoiceStateRequest()
        if include_optional:
            return UpdateVoiceStateRequest(
                suppress = True,

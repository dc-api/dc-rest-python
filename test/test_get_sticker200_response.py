...
class TestGetSticker200Response(unittest.TestCase):
    """GetSticker200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSticker200Response:
        """Test GetSticker200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSticker200Response`
        """
        model = GetSticker200Response()
        if include_optional:
    ...
    def testGetSticker200Response(self):
        """Test GetSticker200Response"""

...
class TestBaseCreateMessageCreateRequest(unittest.TestCase):
    """BaseCreateMessageCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseCreateMessageCreateRequest:
        """Test BaseCreateMessageCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseCreateMessageCreateRequest`
        """
        model = BaseCreateMessageCreateRequest()
        if include_optional:
    ...
    def testBaseCreateMessageCreateRequest(self):
        """Test BaseCreateMessageCreateRequest"""

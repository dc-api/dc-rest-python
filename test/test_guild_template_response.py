...
class TestGuildTemplateResponse(unittest.TestCase):
    """GuildTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildTemplateResponse:
        """Test GuildTemplateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildTemplateResponse`
        """
        model = GuildTemplateResponse()
        if include_optional:
            return GuildTemplateResponse(
                ...
                serialized_source_guild = dc_rest.models.guild_template_snapshot_response.GuildTemplateSnapshotResponse(
                    name = '', 
                    description = '', 
                    region = '', 
    ...
    def testGuildTemplateResponse(self):
        """Test GuildTemplateResponse"""

...
class TestNewMemberActionResponse(unittest.TestCase):
    """NewMemberActionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewMemberActionResponse:
        """Test NewMemberActionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewMemberActionResponse`
        """
        model = NewMemberActionResponse()
        if include_optional:
    ...
    def testNewMemberActionResponse(self):
        """Test NewMemberActionResponse"""

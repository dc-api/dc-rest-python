...
class TestThreadMetadataResponse(unittest.TestCase):
    """ThreadMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadMetadataResponse:
        """Test ThreadMetadataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadMetadataResponse`
        """
        model = ThreadMetadataResponse()
        if include_optional:
    ...
    def testThreadMetadataResponse(self):
        """Test ThreadMetadataResponse"""

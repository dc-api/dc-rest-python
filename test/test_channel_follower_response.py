...
class TestChannelFollowerResponse(unittest.TestCase):
    """ChannelFollowerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChannelFollowerResponse:
        ...
        # uncomment below to create an instance of `ChannelFollowerResponse`
        """
        model = ChannelFollowerResponse()
        if include_optional:
    ...
    def testChannelFollowerResponse(self):
        """Test ChannelFollowerResponse"""

...
class TestMessageReferenceRequest(unittest.TestCase):
    """MessageReferenceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageReferenceRequest:
        """Test MessageReferenceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageReferenceRequest`
        """
        model = MessageReferenceRequest()
        if include_optional:
    ...
    def testMessageReferenceRequest(self):
        """Test MessageReferenceRequest"""

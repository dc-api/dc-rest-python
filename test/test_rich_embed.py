...
class TestRichEmbed(unittest.TestCase):
    """RichEmbed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RichEmbed:
        """Test RichEmbed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RichEmbed`
        """
        model = RichEmbed()
        if include_optional:
            return RichEmbed(
                ...
                provider = dc_rest.models.rich_embed_provider.RichEmbedProvider(
                    name = '', 
                    url = '', ),
                video = dc_rest.models.rich_embed_image.RichEmbedImage(
                    url = '', 
                    width = 56, 
                    height = 56, 
                    placeholder = '', 

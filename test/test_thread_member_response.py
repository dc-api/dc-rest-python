...
class TestThreadMemberResponse(unittest.TestCase):
    """ThreadMemberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadMemberResponse:
        """Test ThreadMemberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadMemberResponse`
        """
        model = ThreadMemberResponse()
        if include_optional:
    ...
    def testThreadMemberResponse(self):
        """Test ThreadMemberResponse"""

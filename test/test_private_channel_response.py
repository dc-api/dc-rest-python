...
class TestPrivateChannelResponse(unittest.TestCase):
    """PrivateChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateChannelResponse:
        """Test PrivateChannelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateChannelResponse`
        """
    ...
    def testPrivateChannelResponse(self):
        """Test PrivateChannelResponse"""

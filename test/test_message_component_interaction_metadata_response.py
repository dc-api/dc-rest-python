...
class TestMessageComponentInteractionMetadataResponse(unittest.TestCase):
    """MessageComponentInteractionMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageComponentInteractionMetadataResponse:
        """Test MessageComponentInteractionMetadataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageComponentInteractionMetadataResponse`
        """
    ...
    def testMessageComponentInteractionMetadataResponse(self):
        """Test MessageComponentInteractionMetadataResponse"""

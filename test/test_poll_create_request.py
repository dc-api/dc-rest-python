...
class TestPollCreateRequest(unittest.TestCase):
    """PollCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PollCreateRequest:
        """Test PollCreateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PollCreateRequest`
        """
        model = PollCreateRequest()
        if include_optional:
    ...
    def testPollCreateRequest(self):
        """Test PollCreateRequest"""

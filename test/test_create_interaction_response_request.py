...
class TestCreateInteractionResponseRequest(unittest.TestCase):
    """CreateInteractionResponseRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateInteractionResponseRequest:
        ...
        # uncomment below to create an instance of `CreateInteractionResponseRequest`
        """
        model = CreateInteractionResponseRequest()
        if include_optional:
    ...
    def testCreateInteractionResponseRequest(self):
        """Test CreateInteractionResponseRequest"""

...
class TestForumTagResponse(unittest.TestCase):
    """ForumTagResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForumTagResponse:
        """Test ForumTagResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForumTagResponse`
        """
        model = ForumTagResponse()
        if include_optional:

...
class TestKeywordRuleResponse(unittest.TestCase):
    """KeywordRuleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordRuleResponse:
        """Test KeywordRuleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordRuleResponse`
        """
        model = KeywordRuleResponse()
        if include_optional:
            return KeywordRuleResponse(
                ...
                trigger_metadata = dc_rest.models.keyword_trigger_metadata_response.KeywordTriggerMetadataResponse(
                    keyword_filter = [
                        ''
                        ], 
                    regex_patterns = [
    ...
    def testKeywordRuleResponse(self):
        """Test KeywordRuleResponse"""

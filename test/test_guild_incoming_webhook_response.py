...
class TestGuildIncomingWebhookResponse(unittest.TestCase):
    """GuildIncomingWebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildIncomingWebhookResponse:
        """Test GuildIncomingWebhookResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildIncomingWebhookResponse`
        """
        model = GuildIncomingWebhookResponse()
        if include_optional:
    ...
    def testGuildIncomingWebhookResponse(self):
        """Test GuildIncomingWebhookResponse"""

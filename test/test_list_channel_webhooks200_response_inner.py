...
class TestListChannelWebhooks200ResponseInner(unittest.TestCase):
    """ListChannelWebhooks200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListChannelWebhooks200ResponseInner:
        ...
        # uncomment below to create an instance of `ListChannelWebhooks200ResponseInner`
        """
        model = ListChannelWebhooks200ResponseInner()
        if include_optional:
    ...
    def testListChannelWebhooks200ResponseInner(self):
        """Test ListChannelWebhooks200ResponseInner"""

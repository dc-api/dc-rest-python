...
class TestGuildPatchRequestPartial(unittest.TestCase):
    """GuildPatchRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildPatchRequestPartial:
        """Test GuildPatchRequestPartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildPatchRequestPartial`
        """
        model = GuildPatchRequestPartial()
        if include_optional:
            return GuildPatchRequestPartial(
                name = '01',
                description = '',
                region = '',
                icon = '',
    ...
    def testGuildPatchRequestPartial(self):
        """Test GuildPatchRequestPartial"""

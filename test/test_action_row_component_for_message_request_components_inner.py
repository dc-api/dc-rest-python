...
class TestActionRowComponentForMessageRequestComponentsInner(unittest.TestCase):
    """ActionRowComponentForMessageRequestComponentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionRowComponentForMessageRequestComponentsInner:
        ...
        # uncomment below to create an instance of `ActionRowComponentForMessageRequestComponentsInner`
        """
        model = ActionRowComponentForMessageRequestComponentsInner()
        if include_optional:
    ...
    def testActionRowComponentForMessageRequestComponentsInner(self):
        """Test ActionRowComponentForMessageRequestComponentsInner"""

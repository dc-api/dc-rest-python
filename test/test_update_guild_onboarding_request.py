...
class TestUpdateGuildOnboardingRequest(unittest.TestCase):
    """UpdateGuildOnboardingRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateGuildOnboardingRequest:
        ...
        # uncomment below to create an instance of `UpdateGuildOnboardingRequest`
        """
        model = UpdateGuildOnboardingRequest()
        if include_optional:
            return UpdateGuildOnboardingRequest(
                prompts = [
                    dc_rest.models.update_onboarding_prompt_request.UpdateOnboardingPromptRequest(
                        title = '0', 
                        options = [
                            dc_rest.models.onboarding_prompt_option_request.OnboardingPromptOptionRequest(
    ...
    def testUpdateGuildOnboardingRequest(self):
        """Test UpdateGuildOnboardingRequest"""

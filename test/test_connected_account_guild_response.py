...
class TestConnectedAccountGuildResponse(unittest.TestCase):
    """ConnectedAccountGuildResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectedAccountGuildResponse:
        ...
        # uncomment below to create an instance of `ConnectedAccountGuildResponse`
        """
        model = ConnectedAccountGuildResponse()
        if include_optional:
    ...
    def testConnectedAccountGuildResponse(self):
        """Test ConnectedAccountGuildResponse"""

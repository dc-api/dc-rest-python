...
class TestLobbyMemberResponse(unittest.TestCase):
    """LobbyMemberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LobbyMemberResponse:
        """Test LobbyMemberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LobbyMemberResponse`
        """
        model = LobbyMemberResponse()
        if include_optional:
    ...
    def testLobbyMemberResponse(self):
        """Test LobbyMemberResponse"""

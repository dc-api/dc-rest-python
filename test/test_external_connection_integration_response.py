...
class TestExternalConnectionIntegrationResponse(unittest.TestCase):
    """ExternalConnectionIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalConnectionIntegrationResponse:
        """Test ExternalConnectionIntegrationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalConnectionIntegrationResponse`
        """
        model = ExternalConnectionIntegrationResponse()
        if include_optional:
    ...
    def testExternalConnectionIntegrationResponse(self):
        """Test ExternalConnectionIntegrationResponse"""

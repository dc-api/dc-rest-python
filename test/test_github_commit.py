...
class TestGithubCommit(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GithubCommit:
        """Test GithubCommit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GithubCommit`
        """
        model = GithubCommit()
        if include_optional:
            return GithubCommit(

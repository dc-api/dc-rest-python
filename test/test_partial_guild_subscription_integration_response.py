...
class TestPartialGuildSubscriptionIntegrationResponse(unittest.TestCase):
    """PartialGuildSubscriptionIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialGuildSubscriptionIntegrationResponse:
        ...
        # uncomment below to create an instance of `PartialGuildSubscriptionIntegrationResponse`
        """
        model = PartialGuildSubscriptionIntegrationResponse()
        if include_optional:
    ...
    def testPartialGuildSubscriptionIntegrationResponse(self):
        """Test PartialGuildSubscriptionIntegrationResponse"""

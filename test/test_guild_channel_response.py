...
class TestGuildChannelResponse(unittest.TestCase):
    """GuildChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildChannelResponse:
        """Test GuildChannelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildChannelResponse`
        """
        model = GuildChannelResponse()
        if include_optional:
    ...
    def testGuildChannelResponse(self):
        """Test GuildChannelResponse"""

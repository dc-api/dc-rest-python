...
class TestOnboardingPromptOptionRequest(unittest.TestCase):
    """OnboardingPromptOptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnboardingPromptOptionRequest:
        """Test OnboardingPromptOptionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnboardingPromptOptionRequest`
        """
        model = OnboardingPromptOptionRequest()
        if include_optional:
    ...
    def testOnboardingPromptOptionRequest(self):
        """Test OnboardingPromptOptionRequest"""

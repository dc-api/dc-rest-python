...
class TestGithubReview(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GithubReview:
        """Test GithubReview
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GithubReview`
        """
        model = GithubReview()
        if include_optional:
            return GithubReview(

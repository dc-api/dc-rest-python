...
class TestApplicationCommandInteractionMetadataResponse(unittest.TestCase):
    """ApplicationCommandInteractionMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationCommandInteractionMetadataResponse:
        """Test ApplicationCommandInteractionMetadataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationCommandInteractionMetadataResponse`
        """
        model = ApplicationCommandInteractionMetadataResponse()
        if include_optional:
    ...
    def testApplicationCommandInteractionMetadataResponse(self):
        """Test ApplicationCommandInteractionMetadataResponse"""

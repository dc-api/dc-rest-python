...
class TestBasicApplicationResponse(unittest.TestCase):
    """BasicApplicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicApplicationResponse:
        """Test BasicApplicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicApplicationResponse`
        """
    ...
    def testBasicApplicationResponse(self):
        """Test BasicApplicationResponse"""

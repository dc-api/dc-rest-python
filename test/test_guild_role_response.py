...
class TestGuildRoleResponse(unittest.TestCase):
    """GuildRoleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildRoleResponse:
        """Test GuildRoleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildRoleResponse`
        """
        model = GuildRoleResponse()
        if include_optional:
    ...
    def testGuildRoleResponse(self):
        """Test GuildRoleResponse"""

...
class TestPinnedMessagesResponse(unittest.TestCase):
    """PinnedMessagesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PinnedMessagesResponse:
        """Test PinnedMessagesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PinnedMessagesResponse`
        """
        model = PinnedMessagesResponse()
        if include_optional:
            return PinnedMessagesResponse(
                items = [
                    dc_rest.models.pinned_message_response.PinnedMessageResponse(
    ...
    def testPinnedMessagesResponse(self):
        """Test PinnedMessagesResponse"""

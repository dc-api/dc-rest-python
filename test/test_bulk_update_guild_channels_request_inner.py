...
class TestBulkUpdateGuildChannelsRequestInner(unittest.TestCase):
    """BulkUpdateGuildChannelsRequestInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkUpdateGuildChannelsRequestInner:
        ...
        # uncomment below to create an instance of `BulkUpdateGuildChannelsRequestInner`
        """
        model = BulkUpdateGuildChannelsRequestInner()
        if include_optional:
    ...
    def testBulkUpdateGuildChannelsRequestInner(self):
        """Test BulkUpdateGuildChannelsRequestInner"""

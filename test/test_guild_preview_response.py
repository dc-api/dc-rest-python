...
class TestGuildPreviewResponse(unittest.TestCase):
    """GuildPreviewResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildPreviewResponse:
        ...
        # uncomment below to create an instance of `GuildPreviewResponse`
        """
        model = GuildPreviewResponse()
        if include_optional:
    ...
    def testGuildPreviewResponse(self):
        """Test GuildPreviewResponse"""

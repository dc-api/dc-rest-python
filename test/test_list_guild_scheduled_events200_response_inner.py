...
class TestListGuildScheduledEvents200ResponseInner(unittest.TestCase):
    """ListGuildScheduledEvents200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGuildScheduledEvents200ResponseInner:
        """Test ListGuildScheduledEvents200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGuildScheduledEvents200ResponseInner`
        """
        model = ListGuildScheduledEvents200ResponseInner()
        if include_optional:
            return ListGuildScheduledEvents200ResponseInner(
                ...
                user_rsvp = dc_rest.models.scheduled_event_user_response.ScheduledEventUserResponse(
                    ...
                    member = dc_rest.models.guild_member_response.GuildMemberResponse(
                        ...
                        mute = True, 
                        deaf = True, ), ),
                entity_metadata = dc_rest.models.confetti_potion.confetti_potion()
            )
        else:
            return ListGuildScheduledEvents200ResponseInner(
                id = '9072888001528021798096225500850762068629339333975650685139102691291',
    ...
    def testListGuildScheduledEvents200ResponseInner(self):
        """Test ListGuildScheduledEvents200ResponseInner"""

...
class TestCreateOrUpdateThreadTagRequest(unittest.TestCase):
    """CreateOrUpdateThreadTagRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrUpdateThreadTagRequest:
        ...
        # uncomment below to create an instance of `CreateOrUpdateThreadTagRequest`
        """
        model = CreateOrUpdateThreadTagRequest()
        if include_optional:
    ...
    def testCreateOrUpdateThreadTagRequest(self):
        """Test CreateOrUpdateThreadTagRequest"""

...
class TestGithubDiscussion(unittest.TestCase):
    """GithubDiscussion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GithubDiscussion:
        ...
        # uncomment below to create an instance of `GithubDiscussion`
        """

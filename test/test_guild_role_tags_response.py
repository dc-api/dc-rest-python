...
class TestGuildRoleTagsResponse(unittest.TestCase):
    """GuildRoleTagsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildRoleTagsResponse:
        """Test GuildRoleTagsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildRoleTagsResponse`
        """
        model = GuildRoleTagsResponse()
        if include_optional:
    ...
    def testGuildRoleTagsResponse(self):
        """Test GuildRoleTagsResponse"""

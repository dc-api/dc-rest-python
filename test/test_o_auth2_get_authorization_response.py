...
class TestOAuth2GetAuthorizationResponse(unittest.TestCase):
    """OAuth2GetAuthorizationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuth2GetAuthorizationResponse:
        """Test OAuth2GetAuthorizationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuth2GetAuthorizationResponse`
        """
        model = OAuth2GetAuthorizationResponse()
        if include_optional:
    ...
    def testOAuth2GetAuthorizationResponse(self):
        """Test OAuth2GetAuthorizationResponse"""

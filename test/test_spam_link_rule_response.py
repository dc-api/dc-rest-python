...
class TestSpamLinkRuleResponse(unittest.TestCase):
    """SpamLinkRuleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpamLinkRuleResponse:
        """Test SpamLinkRuleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpamLinkRuleResponse`
        """
        model = SpamLinkRuleResponse()
        if include_optional:
    ...
    def testSpamLinkRuleResponse(self):
        """Test SpamLinkRuleResponse"""

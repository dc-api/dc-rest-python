...
class TestSoundboardSoundResponse(unittest.TestCase):
    """SoundboardSoundResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoundboardSoundResponse:
        """Test SoundboardSoundResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoundboardSoundResponse`
        """
    ...
    def testSoundboardSoundResponse(self):
        """Test SoundboardSoundResponse"""

...
class TestSettingsEmojiResponse(unittest.TestCase):
    """SettingsEmojiResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SettingsEmojiResponse:
        ...
        # uncomment below to create an instance of `SettingsEmojiResponse`
        """
        model = SettingsEmojiResponse()
        if include_optional:
    ...
    def testSettingsEmojiResponse(self):
        """Test SettingsEmojiResponse"""

...
class TestExternalScheduledEventResponse(unittest.TestCase):
    """ExternalScheduledEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalScheduledEventResponse:
        """Test ExternalScheduledEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalScheduledEventResponse`
        """
        model = ExternalScheduledEventResponse()
        if include_optional:
            return ExternalScheduledEventResponse(
                ...
                user_rsvp = dc_rest.models.scheduled_event_user_response.ScheduledEventUserResponse(
                    ...
                    member = dc_rest.models.guild_member_response.GuildMemberResponse(
                        ...
                        mute = True, 
                        deaf = True, ), ),
                entity_metadata = dc_rest.models.entity_metadata_external_response.EntityMetadataExternalResponse(
                    location = '', )
            )
        else:
            return ExternalScheduledEventResponse(
    ...
    def testExternalScheduledEventResponse(self):
        """Test ExternalScheduledEventResponse"""

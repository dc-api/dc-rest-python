...
class TestGuildSubscriptionIntegrationResponse(unittest.TestCase):
    """GuildSubscriptionIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildSubscriptionIntegrationResponse:
        """Test GuildSubscriptionIntegrationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildSubscriptionIntegrationResponse`
        """
    ...
    def testGuildSubscriptionIntegrationResponse(self):
        """Test GuildSubscriptionIntegrationResponse"""

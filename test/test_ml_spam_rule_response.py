...
class TestMLSpamRuleResponse(unittest.TestCase):
    """MLSpamRuleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MLSpamRuleResponse:
        """Test MLSpamRuleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MLSpamRuleResponse`
        """
        model = MLSpamRuleResponse()
        if include_optional:
    ...
    def testMLSpamRuleResponse(self):
        """Test MLSpamRuleResponse"""

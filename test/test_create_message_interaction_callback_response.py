...
class TestCreateMessageInteractionCallbackResponse(unittest.TestCase):
    """CreateMessageInteractionCallbackResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateMessageInteractionCallbackResponse:
        ...
        # uncomment below to create an instance of `CreateMessageInteractionCallbackResponse`
        """
    ...
    def testCreateMessageInteractionCallbackResponse(self):
        """Test CreateMessageInteractionCallbackResponse"""

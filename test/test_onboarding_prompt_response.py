...
class TestOnboardingPromptResponse(unittest.TestCase):
    """OnboardingPromptResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnboardingPromptResponse:
        """Test OnboardingPromptResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnboardingPromptResponse`
        """
        model = OnboardingPromptResponse()
        if include_optional:
    ...
    def testOnboardingPromptResponse(self):
        """Test OnboardingPromptResponse"""

...
class TestIncomingWebhookUpdateForInteractionCallbackRequestPartial(unittest.TestCase):
    """IncomingWebhookUpdateForInteractionCallbackRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingWebhookUpdateForInteractionCallbackRequestPartial:
        """Test IncomingWebhookUpdateForInteractionCallbackRequestPartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingWebhookUpdateForInteractionCallbackRequestPartial`
        """
        model = IncomingWebhookUpdateForInteractionCallbackRequestPartial()
        if include_optional:
    ...
    def testIncomingWebhookUpdateForInteractionCallbackRequestPartial(self):
        """Test IncomingWebhookUpdateForInteractionCallbackRequestPartial"""

...
class TestUpdateDMRequestPartial(unittest.TestCase):
    """UpdateDMRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateDMRequestPartial:
        ...
        # uncomment below to create an instance of `UpdateDMRequestPartial`
        """
        model = UpdateDMRequestPartial()
        if include_optional:
    ...
    def testUpdateDMRequestPartial(self):
        """Test UpdateDMRequestPartial"""

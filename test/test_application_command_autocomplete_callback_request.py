...
class TestApplicationCommandAutocompleteCallbackRequest(unittest.TestCase):
    """ApplicationCommandAutocompleteCallbackRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationCommandAutocompleteCallbackRequest:
        ...
        # uncomment below to create an instance of `ApplicationCommandAutocompleteCallbackRequest`
        """
        model = ApplicationCommandAutocompleteCallbackRequest()
        if include_optional:
    ...
    def testApplicationCommandAutocompleteCallbackRequest(self):
        """Test ApplicationCommandAutocompleteCallbackRequest"""

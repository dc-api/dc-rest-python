...
class TestScheduledEventResponse(unittest.TestCase):
    """ScheduledEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduledEventResponse:
        """Test ScheduledEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduledEventResponse`
        """
        model = ScheduledEventResponse()
        if include_optional:
    ...
    def testScheduledEventResponse(self):
        """Test ScheduledEventResponse"""

...
class TestRichEmbedVideo(unittest.TestCase):
    """RichEmbedVideo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RichEmbedVideo:
        ...
        # uncomment below to create an instance of `RichEmbedVideo`
        """
        model = RichEmbedVideo()
        if include_optional:

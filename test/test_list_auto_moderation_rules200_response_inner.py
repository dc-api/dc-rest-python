...
class TestListAutoModerationRules200ResponseInner(unittest.TestCase):
    """ListAutoModerationRules200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAutoModerationRules200ResponseInner:
        """Test ListAutoModerationRules200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAutoModerationRules200ResponseInner`
        """
        model = ListAutoModerationRules200ResponseInner()
        if include_optional:
    ...
    def testListAutoModerationRules200ResponseInner(self):
        """Test ListAutoModerationRules200ResponseInner"""

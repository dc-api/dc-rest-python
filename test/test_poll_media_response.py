...
class TestPollMediaResponse(unittest.TestCase):
    """PollMediaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PollMediaResponse:
        """Test PollMediaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PollMediaResponse`
        """
        model = PollMediaResponse()
        if include_optional:
    ...
    def testPollMediaResponse(self):
        """Test PollMediaResponse"""

...
class TestPollAnswerResponse(unittest.TestCase):
    """PollAnswerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PollAnswerResponse:
        """Test PollAnswerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PollAnswerResponse`
        """
        model = PollAnswerResponse()
        if include_optional:
    ...
    def testPollAnswerResponse(self):
        """Test PollAnswerResponse"""

...
class TestStageInstanceResponse(unittest.TestCase):
    """StageInstanceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StageInstanceResponse:
        """Test StageInstanceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StageInstanceResponse`
        """
        model = StageInstanceResponse()
        if include_optional:
    ...
    def testStageInstanceResponse(self):
        """Test StageInstanceResponse"""

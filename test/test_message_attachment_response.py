...
class TestMessageAttachmentResponse(unittest.TestCase):
    """MessageAttachmentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageAttachmentResponse:
        """Test MessageAttachmentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageAttachmentResponse`
        """
        model = MessageAttachmentResponse()
        if include_optional:
    ...
    def testMessageAttachmentResponse(self):
        """Test MessageAttachmentResponse"""

...
class TestMessageEditRequestPartial(unittest.TestCase):
    """MessageEditRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageEditRequestPartial:
        """Test MessageEditRequestPartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageEditRequestPartial`
        """
        model = MessageEditRequestPartial()
        if include_optional:
    ...
    def testMessageEditRequestPartial(self):
        """Test MessageEditRequestPartial"""

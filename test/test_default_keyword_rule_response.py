...
class TestDefaultKeywordRuleResponse(unittest.TestCase):
    """DefaultKeywordRuleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultKeywordRuleResponse:
        ...
        # uncomment below to create an instance of `DefaultKeywordRuleResponse`
        """
        model = DefaultKeywordRuleResponse()
        if include_optional:
            return DefaultKeywordRuleResponse(
                ...
                trigger_metadata = dc_rest.models.default_keyword_list_trigger_metadata_response.DefaultKeywordListTriggerMetadataResponse(
                    allow_list = [
                        ''
                        ], 
                    presets = [
    ...
    def testDefaultKeywordRuleResponse(self):
        """Test DefaultKeywordRuleResponse"""

...
class TestAddGroupDmUser201Response(unittest.TestCase):
    """AddGroupDmUser201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddGroupDmUser201Response:
        """Test AddGroupDmUser201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddGroupDmUser201Response`
        """
        model = AddGroupDmUser201Response()
        if include_optional:
    ...
    def testAddGroupDmUser201Response(self):
        """Test AddGroupDmUser201Response"""

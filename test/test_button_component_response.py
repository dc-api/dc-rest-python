...
class TestButtonComponentResponse(unittest.TestCase):
    """ButtonComponentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ButtonComponentResponse:
        """Test ButtonComponentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ButtonComponentResponse`
        """
        model = ButtonComponentResponse()
        if include_optional:
    ...
    def testButtonComponentResponse(self):
        """Test ButtonComponentResponse"""

...
class TestCreateGuildChannelRequest(unittest.TestCase):
    """CreateGuildChannelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateGuildChannelRequest:
        ...
        # uncomment below to create an instance of `CreateGuildChannelRequest`
        """
        model = CreateGuildChannelRequest()
        if include_optional:
    ...
    def testCreateGuildChannelRequest(self):
        """Test CreateGuildChannelRequest"""

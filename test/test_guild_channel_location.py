...
class TestGuildChannelLocation(unittest.TestCase):
    """GuildChannelLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildChannelLocation:
        """Test GuildChannelLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildChannelLocation`
        """
        model = GuildChannelLocation()
        if include_optional:
    ...
    def testGuildChannelLocation(self):
        """Test GuildChannelLocation"""

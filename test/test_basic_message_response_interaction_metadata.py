...
class TestBasicMessageResponseInteractionMetadata(unittest.TestCase):
    """BasicMessageResponseInteractionMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasicMessageResponseInteractionMetadata:
        """Test BasicMessageResponseInteractionMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BasicMessageResponseInteractionMetadata`
        """
        model = BasicMessageResponseInteractionMetadata()
        if include_optional:
            return BasicMessageResponseInteractionMetadata(
                ...
                triggering_interaction_metadata = None
            )
        else:
            return BasicMessageResponseInteractionMetadata(
                id = '9072888001528021798096225500850762068629339333975650685139102691291',
    ...
    def testBasicMessageResponseInteractionMetadata(self):
        """Test BasicMessageResponseInteractionMetadata"""

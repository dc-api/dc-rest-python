...
class TestGuildMemberResponse(unittest.TestCase):
    """GuildMemberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildMemberResponse:
        """Test GuildMemberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildMemberResponse`
        """
        model = GuildMemberResponse()
        if include_optional:
    ...
    def testGuildMemberResponse(self):
        """Test GuildMemberResponse"""

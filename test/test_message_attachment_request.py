...
class TestMessageAttachmentRequest(unittest.TestCase):
    """MessageAttachmentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageAttachmentRequest:
        ...
        # uncomment below to create an instance of `MessageAttachmentRequest`
        """
        model = MessageAttachmentRequest()
        if include_optional:
    ...
    def testMessageAttachmentRequest(self):
        """Test MessageAttachmentRequest"""

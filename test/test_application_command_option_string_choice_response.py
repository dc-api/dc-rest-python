...
class TestApplicationCommandOptionStringChoiceResponse(unittest.TestCase):
    """ApplicationCommandOptionStringChoiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationCommandOptionStringChoiceResponse:
        ...
        # uncomment below to create an instance of `ApplicationCommandOptionStringChoiceResponse`
        """
        model = ApplicationCommandOptionStringChoiceResponse()
        if include_optional:
    ...
    def testApplicationCommandOptionStringChoiceResponse(self):
        """Test ApplicationCommandOptionStringChoiceResponse"""

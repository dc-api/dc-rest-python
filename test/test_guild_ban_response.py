...
class TestGuildBanResponse(unittest.TestCase):
    """GuildBanResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildBanResponse:
        """Test GuildBanResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildBanResponse`
        """
        model = GuildBanResponse()
        if include_optional:

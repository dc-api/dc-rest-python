...
class TestUserNameplateResponse(unittest.TestCase):
    """UserNameplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserNameplateResponse:
        """Test UserNameplateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserNameplateResponse`
        """
        model = UserNameplateResponse()
        if include_optional:
    ...
    def testUserNameplateResponse(self):
        """Test UserNameplateResponse"""

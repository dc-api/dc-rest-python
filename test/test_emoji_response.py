...
class TestEmojiResponse(unittest.TestCase):
    """EmojiResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmojiResponse:
        """Test EmojiResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmojiResponse`
        """
        model = EmojiResponse()
        if include_optional:

...
class TestUserSelectDefaultValueResponse(unittest.TestCase):
    """UserSelectDefaultValueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserSelectDefaultValueResponse:
        """Test UserSelectDefaultValueResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserSelectDefaultValueResponse`
        """
        model = UserSelectDefaultValueResponse()
        if include_optional:
    ...
    def testUserSelectDefaultValueResponse(self):
        """Test UserSelectDefaultValueResponse"""

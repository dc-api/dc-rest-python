...
class TestGuildTemplateChannelResponse(unittest.TestCase):
    """GuildTemplateChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildTemplateChannelResponse:
        """Test GuildTemplateChannelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildTemplateChannelResponse`
        """
        model = GuildTemplateChannelResponse()
        if include_optional:
            return GuildTemplateChannelResponse(
                id = 56,
                type = 56,
                name = '',
                position = 56,
    ...
    def testGuildTemplateChannelResponse(self):
        """Test GuildTemplateChannelResponse"""

...
class TestPinnedMessageResponse(unittest.TestCase):
    """PinnedMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PinnedMessageResponse:
        """Test PinnedMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PinnedMessageResponse`
        """
        model = PinnedMessageResponse()
        if include_optional:
    ...
    def testPinnedMessageResponse(self):
        """Test PinnedMessageResponse"""

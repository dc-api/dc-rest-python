...
class TestOnboardingPromptOptionResponse(unittest.TestCase):
    """OnboardingPromptOptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnboardingPromptOptionResponse:
        ...
        # uncomment below to create an instance of `OnboardingPromptOptionResponse`
        """
        model = OnboardingPromptOptionResponse()
        if include_optional:
    ...
    def testOnboardingPromptOptionResponse(self):
        """Test OnboardingPromptOptionResponse"""

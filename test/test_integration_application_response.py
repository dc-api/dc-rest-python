...
class TestIntegrationApplicationResponse(unittest.TestCase):
    """IntegrationApplicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationApplicationResponse:
        """Test IntegrationApplicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationApplicationResponse`
        """
        model = IntegrationApplicationResponse()
        if include_optional:
    ...
    def testIntegrationApplicationResponse(self):
        """Test IntegrationApplicationResponse"""

...
class TestDiscordIntegrationResponse(unittest.TestCase):
    """DiscordIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscordIntegrationResponse:
        """Test DiscordIntegrationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscordIntegrationResponse`
        """
        model = DiscordIntegrationResponse()
        if include_optional:
    ...
    def testDiscordIntegrationResponse(self):
        """Test DiscordIntegrationResponse"""

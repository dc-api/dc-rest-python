...
class TestStringSelectOptionResponse(unittest.TestCase):
    """StringSelectOptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StringSelectOptionResponse:
        """Test StringSelectOptionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StringSelectOptionResponse`
        """
        model = StringSelectOptionResponse()
        if include_optional:
    ...
    def testStringSelectOptionResponse(self):
        """Test StringSelectOptionResponse"""

...
class TestPurchaseNotificationResponse(unittest.TestCase):
    """PurchaseNotificationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PurchaseNotificationResponse:
        ...
        # uncomment below to create an instance of `PurchaseNotificationResponse`
        """
        model = PurchaseNotificationResponse()
        if include_optional:
    ...
    def testPurchaseNotificationResponse(self):
        """Test PurchaseNotificationResponse"""

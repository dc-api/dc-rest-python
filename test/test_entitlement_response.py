...
class TestEntitlementResponse(unittest.TestCase):
    """EntitlementResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntitlementResponse:
        """Test EntitlementResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntitlementResponse`
        """
    ...
    def testEntitlementResponse(self):
        """Test EntitlementResponse"""

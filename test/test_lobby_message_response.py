...
class TestLobbyMessageResponse(unittest.TestCase):
    """LobbyMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LobbyMessageResponse:
        """Test LobbyMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LobbyMessageResponse`
        """
        model = LobbyMessageResponse()
        if include_optional:
            return LobbyMessageResponse(
                id = '9072888001528021798096225500850762068629339333975650685139102691291',
                type = 56,
                content = '',
                lobby_id = '9072888001528021798096225500850762068629339333975650685139102691291',
                channel_id = '9072888001528021798096225500850762068629339333975650685139102691291',
                author = dc_rest.models.user_response.UserResponse(
                    id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                    username = '', 
                    avatar = '', 
                    discriminator = '', 
    ...
    def testLobbyMessageResponse(self):
        """Test LobbyMessageResponse"""

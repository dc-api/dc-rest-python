...
class TestFriendInviteResponse(unittest.TestCase):
    """FriendInviteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FriendInviteResponse:
        """Test FriendInviteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FriendInviteResponse`
        """
        model = FriendInviteResponse()
        if include_optional:
    ...
    def testFriendInviteResponse(self):
        """Test FriendInviteResponse"""

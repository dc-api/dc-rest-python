...
class TestWelcomeScreenPatchRequestPartial(unittest.TestCase):
    """WelcomeScreenPatchRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WelcomeScreenPatchRequestPartial:
        ...
        # uncomment below to create an instance of `WelcomeScreenPatchRequestPartial`
        """
        model = WelcomeScreenPatchRequestPartial()
        if include_optional:
            return WelcomeScreenPatchRequestPartial(
                description = '',
                welcome_channels = [
                    dc_rest.models.guild_welcome_channel.GuildWelcomeChannel(
    ...
    def testWelcomeScreenPatchRequestPartial(self):
        """Test WelcomeScreenPatchRequestPartial"""

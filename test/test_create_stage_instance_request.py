...
class TestCreateStageInstanceRequest(unittest.TestCase):
    """CreateStageInstanceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateStageInstanceRequest:
        ...
        # uncomment below to create an instance of `CreateStageInstanceRequest`
        """
        model = CreateStageInstanceRequest()
        if include_optional:
    ...
    def testCreateStageInstanceRequest(self):
        """Test CreateStageInstanceRequest"""

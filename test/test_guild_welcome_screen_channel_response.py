...
class TestGuildWelcomeScreenChannelResponse(unittest.TestCase):
    """GuildWelcomeScreenChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildWelcomeScreenChannelResponse:
        ...
        # uncomment below to create an instance of `GuildWelcomeScreenChannelResponse`
        """
        model = GuildWelcomeScreenChannelResponse()
        if include_optional:
    ...
    def testGuildWelcomeScreenChannelResponse(self):
        """Test GuildWelcomeScreenChannelResponse"""

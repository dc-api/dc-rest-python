...
class TestResourceChannelResponse(unittest.TestCase):
    """ResourceChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceChannelResponse:
        ...
        # uncomment below to create an instance of `ResourceChannelResponse`
        """
        model = ResourceChannelResponse()
        if include_optional:
    ...
    def testResourceChannelResponse(self):
        """Test ResourceChannelResponse"""

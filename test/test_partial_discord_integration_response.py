...
class TestPartialDiscordIntegrationResponse(unittest.TestCase):
    """PartialDiscordIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialDiscordIntegrationResponse:
        ...
        # uncomment below to create an instance of `PartialDiscordIntegrationResponse`
        """
        model = PartialDiscordIntegrationResponse()
        if include_optional:
    ...
    def testPartialDiscordIntegrationResponse(self):
        """Test PartialDiscordIntegrationResponse"""

...
class TestGuildStickerResponse(unittest.TestCase):
    """GuildStickerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuildStickerResponse:
        """Test GuildStickerResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuildStickerResponse`
        """
        model = GuildStickerResponse()
        if include_optional:
    ...
    def testGuildStickerResponse(self):
        """Test GuildStickerResponse"""

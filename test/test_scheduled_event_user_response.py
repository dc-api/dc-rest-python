...
class TestScheduledEventUserResponse(unittest.TestCase):
    """ScheduledEventUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduledEventUserResponse:
        ...
        # uncomment below to create an instance of `ScheduledEventUserResponse`
        """
        model = ScheduledEventUserResponse()
        if include_optional:
    ...
    def testScheduledEventUserResponse(self):
        """Test ScheduledEventUserResponse"""

...
class TestIncomingWebhookInteractionRequest(unittest.TestCase):
    """IncomingWebhookInteractionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingWebhookInteractionRequest:
        """Test IncomingWebhookInteractionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingWebhookInteractionRequest`
        """
        model = IncomingWebhookInteractionRequest()
        if include_optional:
    ...
    def testIncomingWebhookInteractionRequest(self):
        """Test IncomingWebhookInteractionRequest"""

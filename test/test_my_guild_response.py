...
class TestMyGuildResponse(unittest.TestCase):
    """MyGuildResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MyGuildResponse:
        """Test MyGuildResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MyGuildResponse`
        """
        model = MyGuildResponse()
        if include_optional:

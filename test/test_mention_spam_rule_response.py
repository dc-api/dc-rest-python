...
class TestMentionSpamRuleResponse(unittest.TestCase):
    """MentionSpamRuleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MentionSpamRuleResponse:
        """Test MentionSpamRuleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MentionSpamRuleResponse`
        """
        model = MentionSpamRuleResponse()
        if include_optional:
            return MentionSpamRuleResponse(
                ...
                trigger_metadata = dc_rest.models.mention_spam_trigger_metadata_response.MentionSpamTriggerMetadataResponse(
                    mention_total_limit = 56, 
    ...
    def testMentionSpamRuleResponse(self):
        """Test MentionSpamRuleResponse"""

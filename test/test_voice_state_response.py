...
class TestVoiceStateResponse(unittest.TestCase):
    """VoiceStateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VoiceStateResponse:
        """Test VoiceStateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VoiceStateResponse`
        """
        model = VoiceStateResponse()
        if include_optional:
    ...
    def testVoiceStateResponse(self):
        """Test VoiceStateResponse"""

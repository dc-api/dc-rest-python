...
class TestModalSubmitInteractionMetadataResponse(unittest.TestCase):
    """ModalSubmitInteractionMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModalSubmitInteractionMetadataResponse:
        """Test ModalSubmitInteractionMetadataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModalSubmitInteractionMetadataResponse`
        """
        model = ModalSubmitInteractionMetadataResponse()
        if include_optional:
    ...
    def testModalSubmitInteractionMetadataResponse(self):
        """Test ModalSubmitInteractionMetadataResponse"""

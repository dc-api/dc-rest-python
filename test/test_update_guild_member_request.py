...
class TestUpdateGuildMemberRequest(unittest.TestCase):
    """UpdateGuildMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateGuildMemberRequest:
        """Test UpdateGuildMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateGuildMemberRequest`
        """
        model = UpdateGuildMemberRequest()
        if include_optional:
    ...
    def testUpdateGuildMemberRequest(self):
        """Test UpdateGuildMemberRequest"""

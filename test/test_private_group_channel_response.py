...
class TestPrivateGroupChannelResponse(unittest.TestCase):
    """PrivateGroupChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrivateGroupChannelResponse:
        """Test PrivateGroupChannelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrivateGroupChannelResponse`
        """
        model = PrivateGroupChannelResponse()
        if include_optional:
    ...
    def testPrivateGroupChannelResponse(self):
        """Test PrivateGroupChannelResponse"""

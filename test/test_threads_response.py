...
class TestThreadsResponse(unittest.TestCase):
    """ThreadsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadsResponse:
        ...
        # uncomment below to create an instance of `ThreadsResponse`
        """
        model = ThreadsResponse()
        if include_optional:

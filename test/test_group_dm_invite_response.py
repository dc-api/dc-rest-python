...
class TestGroupDMInviteResponse(unittest.TestCase):
    """GroupDMInviteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupDMInviteResponse:
        """Test GroupDMInviteResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupDMInviteResponse`
        """
        model = GroupDMInviteResponse()
        if include_optional:
    ...
    def testGroupDMInviteResponse(self):
        """Test GroupDMInviteResponse"""

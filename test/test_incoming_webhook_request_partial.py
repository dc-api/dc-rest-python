...
class TestIncomingWebhookRequestPartial(unittest.TestCase):
    """IncomingWebhookRequestPartial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingWebhookRequestPartial:
        """Test IncomingWebhookRequestPartial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingWebhookRequestPartial`
        """
        model = IncomingWebhookRequestPartial()
        if include_optional:
    ...
    def testIncomingWebhookRequestPartial(self):
        """Test IncomingWebhookRequestPartial"""

...
class TestWelcomeMessageResponse(unittest.TestCase):
    """WelcomeMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WelcomeMessageResponse:
        ...
        # uncomment below to create an instance of `WelcomeMessageResponse`
        """
        model = WelcomeMessageResponse()
        if include_optional:
    ...
    def testWelcomeMessageResponse(self):
        """Test WelcomeMessageResponse"""

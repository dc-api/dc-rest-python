...
class TestThreadSearchResponse(unittest.TestCase):
    """ThreadSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadSearchResponse:
        """Test ThreadSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadSearchResponse`
        """
        ...
        if include_optional:
            return ThreadSearchResponse(
                ...
                members = [
                    dc_rest.models.thread_member_response.ThreadMemberResponse(
                        id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                        user_id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                        join_timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        flags = 56, 
    ...
    def testThreadSearchResponse(self):
        """Test ThreadSearchResponse"""

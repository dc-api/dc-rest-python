...
class TestLobbyResponse(unittest.TestCase):
    """LobbyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LobbyResponse:
        """Test LobbyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LobbyResponse`
        """
        model = LobbyResponse()
        if include_optional:
            return LobbyResponse(
                ...
                members = [
                    dc_rest.models.lobby_member_response.LobbyMemberResponse(
                        id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                        metadata = {
                            'key' : ''
                            }, 
                ...
                linked_channel = dc_rest.models.guild_channel_response.GuildChannelResponse(
                    id = '9072888001528021798096225500850762068629339333975650685139102691291', 
                    type = 0, 
